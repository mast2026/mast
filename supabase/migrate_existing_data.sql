-- Existing MAST ETA data migration
-- Run after setup_v1.sql and members_import.csv import.
begin;
...
values (
  ...
  '2026-06-05'::date,
  $title$Mast 3기 모집 홍보 1일차🚀$title$,
  $body$1. 공지된 매뉴얼에 따라 글을 작성하고, 포스터 사진을 첨부하여 에브리타임 게시글을 작성해주세요! 📝
2. 작성한 글을 캡쳐한 후 사진을 업로드 해주세요📷$body$,
...
select
  ...
  (('2026-06-05'::date + '23:59:00'::time) at time zone 'Asia/Seoul'),
  ((('2026-06-05'::date + '23:59:00'::time) at time zone 'Asia/Seoul') + interval '24 hours'),
  'Migrated from previous Supabase data'
...
values
  ...
  select op.*, a.id as assignment_id, a.member_id, a.due_at,
    case
      ...
      when op.old_status = 'pending' then 'submitted'
...
with old_proofs (mission_id, member_key, old_status, submitted_at) as (
values
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '정효상|2기|강원대학교', 'approved', '2026-06-05 13:35:24.118+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '양지민|2기|서울여자대학교', 'approved', '2026-06-05 04:11:44.438+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '박수현|2기|한양대학교 에리카캠퍼스', 'approved', '2026-06-05 04:57:33.651+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '김종하|1기|숭실대학교', 'approved', '2026-06-05 03:14:11.532+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '유현민|1기|경희대학교', 'approved', '2026-06-05 13:45:52.141+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '조규영|1기|단국대학교', 'approved', '2026-06-05 04:17:19.437+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '박준영|2기|수원대학교', 'approved', '2026-06-05 03:27:06.37+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '이수민|2기|부산가톨릭대학교', 'approved', '2026-06-05 04:53:10.953+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '김수민|2기|한국외국어대학교 글로벌캠퍼스', 'approved', '2026-06-05 03:44:38.025+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '김채현|2기|숙명여자대학교', 'approved', '2026-06-05 03:14:39.251+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '김아현|2기|중앙대학교', 'approved', '2026-06-05 04:02:47.025+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '이지민|2기|유니스트', 'approved', '2026-06-05 06:15:30.313+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '박규리|1기|충북대학교', 'approved', '2026-06-05 13:03:57.605+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '이사랑|2기|연세대학교 미래캠퍼스', 'approved', '2026-06-05 03:14:18.949+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '장지호|1기|울산대학교', 'approved', '2026-06-05 14:26:15.359+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '김대한|1기|한경국립대학교', 'approved', '2026-06-05 04:11:40.164+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '최진서|1기|홍익대학교', 'approved', '2026-06-05 13:41:10.849+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '김혜원|1기|동국대학교', 'approved', '2026-06-05 03:15:50.425+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '문서영|1기|건국대학교', 'approved', '2026-06-05 14:08:59.651+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '이서준|1기|상지대학교', 'approved', '2026-06-05 09:04:57.837+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '김민서|2기|가천대학교', 'approved', '2026-06-05 06:34:00.143+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '양하영|1기|부산외국어대학교', 'approved', '2026-06-05 03:17:11.26+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '박재형|2기|명지대학교', 'approved', '2026-06-05 03:28:18.3+00'::timestamptz),
  ('e58b1961-dde4-4afd-814d-86bb00ee0f00'::uuid, '성지연|2기|고려대학교 세종캠퍼스', 'approved', '2026-06-05 05:30:01.591+00'::timestamptz)
), matched as (
...
set
  ...
  reviewed_at = case when m.new_status in ('approved', 'late', 'rejected') then m.submitted_at else null end,
  status_reason = case
    when m.new_status = 'submitted' then null
    else 'Migrated from previous Supabase proof status'
  end
from matched m
where a.id = m.assignment_id;

-- Check migration result
select status, count(*) from public.promotion_mission_assignments group by status order by status;
